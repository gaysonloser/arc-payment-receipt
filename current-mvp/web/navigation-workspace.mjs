...
function a12UiSource(value) {
  ...
  return /(?:A12|C15|runtime|packet|producer|governance|handoff|manifest|sha|exchange)/i.test(text) ? "Typed local source" : text || "Typed local source";
}
...
function a12UiStyles() {
  ...
  style.textContent = `
    ...
    .a12-app[data-current-workspace="milestone-desk"] .a12-canvas{padding-bottom:132px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-summary{position:relative;top:auto;padding-bottom:8px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-layout{gap:14px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-step{min-height:70px;padding:10px 12px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-summary .a12-summary-panel{padding:11px 12px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-summary .a12-summary-panel h3{margin-bottom:7px}.a12-app[data-current-workspace="milestone-desk"] .a12-summary-pairs>div{padding:7px 6px}.a12-app[data-current-workspace="milestone-desk"] .a12-decision-row{padding:7px 8px}.a12-app[data-current-workspace="milestone-desk"] .a12-decision-row+.a12-decision-row{margin-top:5px}.a12-app[data-current-workspace="milestone-desk"] .a12-bottom-action{min-height:78px;padding:10px 22px}
    @media(max-width:1050px){.a12-app[data-current-workspace="milestone-desk"] .a12-canvas{padding-bottom:124px}.a12-app[data-current-workspace="milestone-desk"] .a12-bottom-action{min-height:76px;padding:9px 16px}}
    @media(max-width:720px){.a12-app[data-current-workspace="milestone-desk"] .a12-canvas{padding-bottom:164px}.a12-app[data-current-workspace="milestone-desk"] .a12-bottom-action{min-height:88px;padding:10px 12px}}
