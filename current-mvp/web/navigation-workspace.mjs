...
function a12UiStyles() {
  ...
  style.textContent = `
    ...
    @media(max-width:900px){.a12-workspace-grid{grid-template-columns:1fr}.a12-workspace-guide{grid-template-columns:52px minmax(0,1fr)}.a12-workspace-guide img{width:52px;height:52px}.a12-reconciliation-table{min-width:760px}.a12-reconciliation-table+ .a12-boundary{margin-top:12px}}
