...
function a12UiStyles() {
  ...
  style.textContent = `
    ...
    .a12-app[data-current-workspace="milestone-desk"] .a12-case-header h1{font-family:Georgia,"Times New Roman",serif;font-size:30px;font-weight:650}.a12-app[data-current-workspace="milestone-desk"] .a12-object-summary{display:none}.a12-app[data-current-workspace="milestone-desk"] .a12-object-line{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:6px}.a12-app[data-current-workspace="milestone-desk"] .a12-object-ref{min-height:38px;padding:5px 7px;overflow:hidden}.a12-app[data-current-workspace="milestone-desk"] .a12-object-ref b{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    ...
    .a12-app[data-current-workspace="milestone-desk"] .a12-milestone-layout{grid-template-columns:minmax(0,1.55fr) minmax(320px,.78fr);align-items:start}.a12-app[data-current-workspace="milestone-desk"] .a12-workspace-primary{margin-top:10px;padding:12px}.a12-app[data-current-workspace="milestone-desk"] .a12-workspace-guide{grid-template-columns:48px minmax(0,1fr);gap:10px;margin-bottom:10px;padding-bottom:10px}.a12-app[data-current-workspace="milestone-desk"] .a12-workspace-guide img{width:48px;height:48px}.a12-app[data-current-workspace="milestone-desk"] .a12-workspace-guide h2{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-summary{position:sticky;top:16px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-supporting-detail{margin-top:16px}.a12-app[data-current-workspace="milestone-desk"] .a12-milestone-supporting-detail>summary{background:#fffdf8}
    ...
    @media(max-width:720px){.a12-app[data-current-workspace="milestone-desk"] .a12-bottom-action{left:0}.a12-summary-pairs{grid-template-columns:1fr}.a12-app[data-current-workspace="milestone-desk"] .a12-object-line{grid-template-columns:1fr 1fr}}
    ...
    @media(max-width:1050px){.a12-app[data-current-workspace="milestone-desk"] .a12-canvas{padding-bottom:104px}.a12-app[data-current-workspace="milestone-desk"] .a12-bottom-action{min-height:76px;padding:9px 16px}}
