...
**Current product source:** [GitHub `main`](https://github.com/gaysonloser/arc-payment-receipt/tree/main) contains the accepted H187 product implementation. The implementation commit is [`c5c6866`](https://github.com/gaysonloser/arc-payment-receipt/commit/c5c6866d31b5d50d740df1e6a589cf868367e037); it adds deterministic Circle Console, ERP, Encode, Final and Arc readback validators while keeping every absent receipt fail-closed.
...
- Current product implementation: [`c5c6866d31b5d50d740df1e6a589cf868367e037`](https://github.com/gaysonloser/arc-payment-receipt/commit/c5c6866d31b5d50d740df1e6a589cf868367e037), published to `main` and deployed on Render.
...
- Published runtime: [Render `/current-mvp/`](https://arc-payment-receipt.onrender.com/current-mvp/); H187 deployment and the new read-only surface-readiness endpoint were both read back with HTTP 200.
